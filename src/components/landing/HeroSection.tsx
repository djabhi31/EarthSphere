      ...
      <div className="dark:bg-transparent dark:border-none dark:shadow-none dark:backdrop-blur-none dark:p-0 backdrop-blur-2xl bg-[var(--surface-overlay)]/85 border border-[var(--border-default)] p-6 sm:p-10 md:p-12 rounded-3xl shadow-2xl shadow-black/10 text-center transition-all">
        ...
        >
          <span className="relative flex h-2.5 w-2.5">
            ...
            <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[var(--electric-cyan)]" />
          </span>
          <span className="text-xs font-bold uppercase tracking-wider text-[var(--electric-cyan)]">
        ...
        <motion.p
          className="mx-auto mb-8 max-w-2xl text-base font-medium leading-relaxed text-[var(--text-secondary)] sm:text-lg md:text-xl select-text"
        ...
        >
          <Link
            ...
            className="flex items-center gap-1.5 rounded-full border border-[var(--solar-orange)]/40 bg-[var(--solar-orange)]/15 px-3.5 py-1.5 text-xs font-bold text-[var(--solar-orange)] hover:bg-[var(--solar-orange)]/25 transition-colors shadow-sm"
          >
            🔥 Wildfires
          </Link>
          <Link
            ...
            onMouseEnter={() => audioSynth.playHover()}
            onClick={() => audioSynth.playClick()}
            className="flex items-center gap-1.5 rounded-full border border-[var(--ice-blue)]/40 bg-[var(--ice-blue)]/15 px-3.5 py-1.5 text-xs font-bold text-[var(--ice-blue)] hover:bg-[var(--ice-blue)]/25 transition-colors shadow-sm"
          >
            🌀 Severe Storms
          </Link>
          <Link
            ...
            onMouseEnter={() => audioSynth.playHover()}
            onClick={() => audioSynth.playClick()}
            className="flex items-center gap-1.5 rounded-full border border-[var(--warning-red)]/40 bg-[var(--warning-red)]/15 px-3.5 py-1.5 text-xs font-bold text-[var(--warning-red)] hover:bg-[var(--warning-red)]/25 transition-colors shadow-sm"
          >
            🌋 Volcanoes
          </Link>
          <Link
            ...
            onMouseEnter={() => audioSynth.playHover()}
            onClick={() => audioSynth.playClick()}
            className="flex items-center gap-1.5 rounded-full border border-[var(--cosmic-purple)]/40 bg-[var(--cosmic-purple)]/15 px-3.5 py-1.5 text-xs font-bold text-[var(--cosmic-purple)] hover:bg-[var(--cosmic-purple)]/25 transition-colors shadow-sm"
          >
            ⚡ Earthquakes
          </Link>
        </motion.div>
        ...
        >
          ...
          <span className="text-sm font-semibold text-[var(--text-secondary)]">Live Global Feed:</span>
          <AnimatedCounter
            value={stats?.totalActive ?? 0}
            className="text-base font-extrabold text-[var(--electric-cyan)] tabular-nums"
          />
          <span className="text-sm font-semibold text-[var(--text-secondary)]">active disasters tracked</span>
        </motion.div>
